...
const SignUp = (props)=>{
    ...
    return(<><div style={{width:"60%", marginLeft:"30%", marginBottom:"5%"}}>
        <div className="formsBox">
            ...
            <input type="text" name="surname" onChange={data} placeholder="surname"  />
            ...
            <input type="text" name="profilePic" onChange={data} placeholder="Profile Picture"/>
            <input type="password" name="password" onChange={data} placeholder="Password"/>
            <label htmlFor="country">Country</label><span style={{color:" red", display: "inline", float: "none"}}>*</span>      
        
            <select id="country" name="country" onChange={data} className="form-control">
...
const mapDispatchToProps ={
	newAccount: userActions.newAccount
}
