...
class Carrusel extends React.Component {
    state = {
        ...
        { pic: "https://www.ahkargentina.com.ar/fileadmin/AHK_Argentinien/sobre_alemania_img.png", nombre: 'Germany' },
        ...
        { pic: "https://www.luxorandaswan.com/es/featured/3%20Days%202%20Nights%20Short%20vacations.jpg", nombre: 'Egypt' },
            ...
            <>
                <div style={{ width: '100%',marginBottom:'10vh' }}>
                    ...
                    >
                     ...
                     <div key={index} style={{ width: '400px', height: '400px', display: 'flex', flexWrap: 'wrap'}}>
                            <Slide data={place}/> 
                     </div>
